#!/usr/bin/env bash
# Wrapper for test/tests/timesteppers/foam_adjustable_run_time — replicates
# the TestHarness pipeline (tests file:
# foam_adjustable_run_time/{setup,run,verify}).
...
run_verify() {
  step "verify: check adjustable run-time output folders"
